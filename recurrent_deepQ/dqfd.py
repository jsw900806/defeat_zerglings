...
from baselines.deepqLSTM.replay_buffer import ReplayBuffer, PrioritizedReplayBuffer
...
class ActWrapper(object):
  ...
  def load(path, act_params, num_cpu=16):
    ...
    act = deepqLSTM.build_act(**act_params)
...
def learn(env,
  ...
  act, train, update_target, debug = deepqLSTM.build_train(
